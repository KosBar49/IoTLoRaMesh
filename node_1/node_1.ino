...
#define ENDNODE_ADDRESS 1 // purposefully using the last namber
...
const uint8_t selfAddress_ = NODE2_ADDRESS;  // CHANGE THIS!!!
...
void loop() {
  ...
  //   printf("Sending \"%s\" to %d...", msgSend.c_str(), targetAddress_);
  //   uint8_t _err =
  ...
  //     //esp_task_wdt_reset();
  //     printf(" successfull! Awaiting for Reply\n");
...
//      esp_task_wdt_reset();
      ...
      String _msgRply = String("Hi node " + String(_msgFrom) +"!");
